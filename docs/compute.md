...
@signature `canCompute( getterSetter[, context] )`
...
@signature `canCompute( initialValue [, settings] )`
...
@signature `canCompute( initialValue, setter(newVal,oldVal) )`
...
@signature `canCompute( object, propertyName [, eventName] )`
